...
| 10.3 | **Propagate `Snapshot` object** into the Ruby/Swift/Kotlin/Go/C# wrappers + per-language smoke | Each wrapper exposes the object idiomatically; smoke compiles/passes | 10.1 | cc:WIP (Go✓ C#✓; Ruby/Swift/Kotlin next) |
