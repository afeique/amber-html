...
| 1.2 | Sufficiency scoring + tiered-fetch escalation (`--render auto`) | Static-vs-browser verdict computed from markers + content check; uncertain → render | 1.1, 0.4 | cc:WIP |
...
| 1.12 | Page metadata (title/lang/canonical/OpenGraph/links) | Metadata extracted and exposed on `Snapshot` | 1.1 | cc:TODO |
...
| 1.15 | Structured logging + tracing | `tracing` spans across fetch/settle/capture; configurable level | 0.1 | cc:TODO |
...
| 2.9 | Language detection / encoding | Detected language and correct decoding on non-UTF-8 pages | 1.1 | cc:TODO |
